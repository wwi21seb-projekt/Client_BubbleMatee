...
<a class = "chip variant-soft-secondary  hover:variant-filled-secondary dark:variant-soft-primary  darkhover:variant-filled-primary  flex flex-row justify-center items-center text-base md:text-lg rounded-xl px-5 py-1 mb-1"
