...
export const currentUser = writable<User>({ username: '', email: '', nickname: '' }); //TODOS: Why is this needed?
export const authToken = writable<string | null>(null); //TODOS: Why is this needed?
